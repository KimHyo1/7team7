...
| 이름 | 역할 | GitHub |
| --- | --- | --- |
| 김대호 | 팀장 | [@hohoho0961](https://github.com/hohoho0961) |
| 김효 | 팀원 | [@KimHyo1](https://github.com/KimHyo1) |
| 유기연 | 팀원 | [@GiyeonYOOO](https://github.com/GiyeonYOOO) |

## 프로젝트 후기 한줄평
- **김대호** : 이번 팀 프로젝트를 통해 여행 시뮬레이션 게임 웹사이트를 개발하며 개인적으로도, 팀원들과의 관계에 있어서도 정말 값진 경험을 할 수 있었습니다.
평소에는 대화해 볼 기회가 적었던 팀원들과 매일 소통하고 아이디어를 조율하면서 서로에 대해 더 깊이 이해하고 한층 더 친해질 수 있는 계기가 되었습니다. 혼자서 개발할 때와는 달리, 각자의 역할을 나누고 조율하는 과정 속에서 진정한 협업의 가치와 원활한 커뮤니케이션의 중요성을 배울 수 있었습니다.
특히, 머릿속으로만 구상했던 기획이 코드로 구현되어 하나의 웹사이트라는 결과물로 완성되는 과정을 지켜보는 것이 정말 흥미로웠습니다. 최종 결과물을 직접 실행해 보며 느낀 성취감과 재미는 앞으로 새로운 도전을 해나가는 데 있어 큰 원동력이 될 것 같습니다.
- **김효** : 첫 팀원들과 프로젝트를 진행하다보니 어려운점도 많았고 헤맨 부분도 많았지만, 짧게라도 협업을 경험해보고 서로 도움받으면서 결과물을 만들어내는 과정이 뿌듯했습니다.처음에는 프롬프트만 입력하면 완벽하게 만들어 줄 것이라고 생각했지만, 실제로는 원하는 결과를 얻기 위해 여러번 수정을 하고 직접 코드를 보완해야 했습니다.이 과정에서 개인의 문제 해결 능력도 키워야겠다고 생각하게 되었습니다!

- **유기연** : 원하는 기능과 화면을 요청하면 기본적인 코드를 빠르게 만들어줘서 편리했습니다. 그래도 원하는 결과를 얻으려면 직접 요구사항을 구체적으로 수정하고 코드를 조정하는 과정이 필요하다는 것을 배웠습니다. 그리고 AI가 작성한 코드를 그대로 사용하는 것이 아니라 내용을 이해하고 필요한 부분을 수정하는 능력이 중요하다는 점을 알게 되었습니다.
이를 통해서 AI는 개발을 대신하는 도구가 아니라 개발을 도와주는 도구라는 것을 느꼈으며, 앞으로는 AI를 활용하면서도 스스로 문제를 해결하는 능력을 키워야 겠다고 생각했습니다
